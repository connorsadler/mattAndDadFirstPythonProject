...
def main():
    ...
    playareawidth = 400
    playareaheight = 400
    size =[playareawidth, playareaheight]
    ...
    while True:
        ...
        # wallspeed will be 1 for moving right, and -1 for moving left
        wall.rect.x = wall.rect.x + wallspeed
        if (wall.rect.x >= playareawidth):
            wallspeed = -1
        if (wall.rect.x <= 0):
            wallspeed = 1
